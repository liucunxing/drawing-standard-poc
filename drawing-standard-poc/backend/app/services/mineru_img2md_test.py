...
def _split_vertical_2(image, overlap_px=140):
    """Split image into two vertical chunks with overlap for tall table continuity."""
    h = image.height
    split_y = h // 2
...
def _should_split_image(image_path, resized_image, size_mb_threshold=1.0, height_threshold=3600, aspect_threshold=2.0):
